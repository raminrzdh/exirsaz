...
export async function createAgency(data: any) {
  ...
  return { 
    ...
    agency: {
      ...
      slug: completeAgency.slug || '',
      company: completeAgency.company || '',
      manager: completeAgency.manager || '',
      mobile: completeAgency.mobile || '',
      image: completeAgency.image || '',
      description: completeAgency.description || '',
