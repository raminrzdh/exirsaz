      ...
      <section className="bg-slate-900 text-white py-16 md:py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-20 flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            ...
            <h1 className="text-4xl md:text-5xl font-black mb-4">  {agency.name}</h1>
            {agency.company && (
                ...
                {agency.phone && (
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href={`tel:${agency.phone}`} className="text-slate-600 mt-1 hover:text-emerald-600 transition-colors inline-block" dir="ltr">
                        {toPersianDigits(agency.phone)}
                      </a>
                    </div>
                  </div>
                )}
                ...
                {agency.mobile && (
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href={`tel:${agency.mobile}`} className="text-slate-600 mt-1 hover:text-emerald-600 transition-colors inline-block" dir="ltr">
                        {toPersianDigits(agency.mobile)}
                      </a>
                    </div>
                  </div>
                )}
